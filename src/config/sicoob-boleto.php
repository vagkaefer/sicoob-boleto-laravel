...
return [
  ...
  'sb_api_url' => env('SB__AUTH_URL', 'https://api.sicoob.com.br/cobranca-bancaria/v2/'), //In this moment, we don't have Sandbox
  'sb_certificate_file' => env('SB_CERTIFICATE_FILE', null),
  'sb_certificate_password' => env('SB_CERTIFICATE_PASSWORD', null),
  'sb_numero_contrato' => env('SB_NUMERO_CONTRATO', null),
